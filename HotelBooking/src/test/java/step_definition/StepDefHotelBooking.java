...
public class StepDefHotelBooking {
	...
	System.setProperty("webdriver.chrome.driver","C:\\Users\\SUMAHALI\\eclipse-workspace\\HotelBooking\\Driver\\chromedriver.exe");
...
public void user_is_on_hotel_booking_page() throws Throwable {
	...
	//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	//objhbpg = new HotelBookingPageFactory(driver);
	driver.get("file:///C:/Users/SUMAHALI/Downloads/M2/HotelBooking%20And%20Success%20HTML/hotelbooking.html");
}
...
public void user_enters_all_valid_data() throws Throwable {
	objhbpg.setPffname("Sundar");	Thread.sleep(1000);
	objhbpg.setPflname("Raj");	Thread.sleep(1000);
	objhbpg.setPfemail("sundarraj1234@gmail.com");	Thread.sleep(1000);
	objhbpg.setPfmobile("9876543212");	Thread.sleep(1000);
	objhbpg.setPfcity("Chennai");	Thread.sleep(1000);
	objhbpg.setPfstate("Tamilnadu");	Thread.sleep(1000);
	objhbpg.setPfpersons(5);	Thread.sleep(1000);
	objhbpg.setPfcardholder("sundar raj");	Thread.sleep(1000);
	objhbpg.setPfdebit("6578567867898907");	Thread.sleep(1000);
	objhbpg.setPfcvv("087");	Thread.sleep(1000);
	objhbpg.setPfmonth("9");	Thread.sleep(1000);
	objhbpg.setPfyear("2026"); 
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	objhbpg.setPfbutton();
	//driver.close();
...
public void navigate_to_welcome_page() throws Throwable {
	driver.navigate().to("file:///C:/Users/SUMAHALI/Downloads/M2/HotelBooking%20And%20Success%20HTML/success.html");
...
public void user_leaves_expirationMonth_blank_and_clicks_the_button() throws Throwable {
	...
	objhbpg.setPflname("Raj");	Thread.sleep(1000);
	objhbpg.setPfemail("sundarraj1234@gmail.com");	Thread.sleep(1000);
	objhbpg.setPfmobile("7722008780");	Thread.sleep(1000);
	objhbpg.setPfcity("Chennai");	Thread.sleep(1000);
	objhbpg.setPfstate("Tamilnadu");	Thread.sleep(1000);
	objhbpg.setPfpersons(7);	Thread.sleep(1000);
	objhbpg.setPfcardholder("Sundar Raj");	Thread.sleep(1000);
...
public void user_leaves_expirationYr_blank_and_clicks_the_button() throws Throwable {
	objhbpg.setPffname("Sundar");	Thread.sleep(1000);
	objhbpg.setPflname("Raj");	Thread.sleep(1000);
	objhbpg.setPfemail("su.r@gmail.com");	Thread.sleep(1000);
	objhbpg.setPfmobile("9876543212");	Thread.sleep(1000);
	objhbpg.setPfcity("Chennai");	Thread.sleep(1000);
	objhbpg.setPfstate("Tamilnadu");	Thread.sleep(1000);
	objhbpg.setPfpersons(7);	Thread.sleep(1000);
	objhbpg.setPfcardholder("su Raj");	Thread.sleep(1000);
